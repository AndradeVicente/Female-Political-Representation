...
bandwidths <- c(0.05, 0.10, 0.157, 0.25)
...
resultados |> 
  ...
  tab_header(
    ...
    subtitle = md("Bandwidth value of 15,7% - CCT"))
...
base_placebo <- base_rdd |> 
  filter(abs(mg_preto) <= 0.155)

rdplot(base_placebo$y_homicide_previous, base_placebo$mg_preto, c = 0, nbins = c(10, 10), kernel = 'triangular', x.lim = c(-0.155,0.155), y.lim = c(20, 70), p = TRUE)
